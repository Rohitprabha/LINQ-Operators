    ...
    public class Student
    {
        ...
        public static List<Student> GetStudents()
        {
            return new List<Student>()
            {
                ...
                new Student(){ID = 2, Name = "Sam", Email = "Sara@j.com", Programming = new List<string>() { "C", "SQL Server", "C#" }},
                new Student(){ID = 3, Name = "Patrik", Email = "Patrik@j.com", Programming = new List<string>() { "MVC", "Java", "LINQ"} },
                new Student(){ID = 4, Name = "Sara", Email = "Sara@j.com", Programming = new List<string>() { "C", "C#", "LINQ" } }
            };
        }
    }
}
